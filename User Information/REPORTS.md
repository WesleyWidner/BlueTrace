...
Blue Trace enables you to generate detailed PDF reports from your scan results.  
To ensure successful report creation, please review the following requirements and workflow.
...
**Save your scan as JSON** (select the JSON export option after completing your scan).  
**Ensure the JSON file is in the `BlueTraceReports` folder**.  
...
**Go to the Reports section** in Blue Trace.  
**Select the scan you wish to report on** from the available list.  
**Click “Generate Report”** to create a detailed PDF report.
